...
class NewIndividualMember(forms.Form):
    ...
    def execute(self):
        ...
        print(cleaned_data)
        person = Person.objects.create(name=cleaned_data['name'], surname=cleaned_data['surname'], phone_number=cleaned_data['phone'], address_street=cleaned_data['adress'], id_number=cleaned_data['id_number'], email=cleaned_data['mail'])
        print(person)
